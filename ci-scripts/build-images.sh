...
sudo LIBGUESTFS_BACKEND=direct \
guestfish -a centos.qcow2 -i <<EOF
copy-out /ironic-python-agent.initramfs .
copy-out /ironic-python-agent.vmlinuz .
copy-out /overcloud-full.qcow2 .
copy-out /overcloud-full.initrd .
copy-out /overcloud-full.vmlinuz .
EOF
