...
class CopyQuayClient(object):
    ...
    def promote(self, candidate_hash, target_label, candidate_label=None,
        ...
        cmd = f"../infra-setup/roles/copy_container/files/copy-quay/" \
              f"copy-quay copy " \
              f"--config ../infra-setup/roles/copy_container/files/copy-quay" \
              f"/config.yaml --release {self.config.release} " \
