...
class DlrnHash(object):
    ...
    Dlrn hash for the single pipeline or a Dlrn aggregated hash for the
    ...
    def __new__(self, commit_hash=None, distro_hash=None, timestamp=None,
