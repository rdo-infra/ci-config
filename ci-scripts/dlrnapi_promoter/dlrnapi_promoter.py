...
def archive_logs(log_file, archival_file):
...
def main(cmd_line=None):
    ...
    archival_file_name = log_file.split(".")[0] + "-" + date_today + ".log"
    archive_logs(log_file, archival_file_name)
    log.info("Logging to: {}".format(archival_file_name))
