...
def promote_all_links(api, promote_from, job_reqs, dry_run, release, latest_hashes_count):
    ...
    for promote_name, current_name in promote_from.items():
        ...
        latest_hashes = [new_hashes for new_hashes in latest_hashes if not check_promoted(api, promote_name, new_hashes) and new_hashes['timestamp'] > old_hashes['timestamp']]
