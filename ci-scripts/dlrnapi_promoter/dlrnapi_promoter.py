...
def fetch_current_named_hashes(distro, release, promote_from):
    ''' Get latest known named hashes from trunk.rdoproject.org '''
    distro_name, distro_version = distro
    named_hashes_result = {}
    for hash_name in promote_from.keys():
...
def check_named_hashes_unchanged(distro, release, promote_from):
        ...
        for new_hashes in get_latest_hashes(api, promote_name, current_name,
            ...
            if dry_run:
                ...
                try:
                    ...
                    check_named_hashes_unchanged(distro, release, promote_from)
