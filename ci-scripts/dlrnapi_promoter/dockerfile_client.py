...
class DockerfileClient(object):
    ...
    def __init__(self, config):
        ...
        self.rollback_links = {}
        server_conf = self.config.overcloud_images.get('dockerfile_servers')
        qcow_server = self.config.default_dockerfile_server
    ...
    def promote(self, candidate_hash, target_label, candidate_label=None,
                create_previous=True, validation=False):
        """
