...
class Promoter(object):
    ...
    def promote_label_to_label(self, candidate_label, target_label):
        ...
        if 'alternative_criteria' in self.config.promotions[target_label]:
            alt_criteria = \
               self.config.promotions[target_label]['alternative_criteria']
        ...
        for candidate_hash in selected_candidates:
            ...
            if len(missing_jobs_direct) and alt_criteria is not None:
                for missing_job_direct in missing_jobs_direct:
                    if missing_job_direct in alt_criteria:
                        for alt_job in alt_criteria[missing_job_direct]:
