    ...
    def select_candidates(self, candidate_label, target_label):
        ...
        if self.config.pipeline_type == "single":
            ...
            for hashes in candidate_hashes_list:
                candidate_hashes[hashes.id] = {}
                candidate_hashes[hashes.id][candidate_label] = hashes.timestamp
            ...
            if old_hashes is None:
                ...
                for hashes in old_hashes:
                    ...
                    # ignoring it
                    if hashes.id in candidate_hashes:
            ...
            for index, hashes in enumerate(candidate_hashes_list):
                if target_label in candidate_hashes[hashes.id]:
                    self.log.info(
