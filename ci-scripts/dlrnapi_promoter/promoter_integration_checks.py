...
def check_dlrn_promoted_hash(*args, stage_info=None):
...
def query_container_registry_promotion(*args, stage_info=None):
...
def compare_tagged_image_hash(*args, stage_info=None):
...
def parse_promotion_logs(*args, stage_info=None):
