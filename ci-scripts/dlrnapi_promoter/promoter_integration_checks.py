...
def compare_tagged_image_hash(stage_info=None, **kwargs):
    ...
    error_msg = "{} points to wrong dir {} ".format(target_label, linked_dir)
...
def parse_promotion_logs(stage_info=None, **kwargs):
    ...
    if stage_info is not None:
        ...
        # Funcional tests drive promoter configuration and forces a
        # logfile location in the stage dir. In functional tests we need to
        # check that log file.
        # In Integration tests the promoter is run indipentently and the log
