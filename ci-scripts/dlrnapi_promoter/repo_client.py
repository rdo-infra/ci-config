    ...
    def get_containers_list(self, tripleo_common_commit, load_excludes=True):
        ...
        if container_list:
            ...
            # container_images is the rendered container list, not the jinja
                ...
                # In container-images/tripleo_containers.yaml, the containers are
                # named openstack-*.
                # In container-images/overcloud_containers.yaml, the containers are
                # named distro-binary-*.
                if "tripleo" in self.containers_list_path:
                  ...
                  self.log.error("invalid tripleo-common containers list passed")
        else:
            full_list = []
