...
from promoter.dlrn_client import HashChangedError
...
class TestPromote(ConfigSetup):
    ...
    @patch('promoter.dlrn_client.DlrnClient.check_named_hashes_unchanged')
    @patch('promoter.dlrn_client.DlrnClient.promote')
    @patch('promoter.registries_client.RegistriesClient.promote')
    @patch('promoter.qcow_client.QcowClient.promote')
...
class TestPromoteLabelToLabel(ConfigSetup):
    ...
    @patch('logging.Logger.info')
    @patch('logging.Logger.warning')
    @patch('promoter.logic.Promoter.select_candidates')
    @patch('promoter.logic.Promoter.promote')
    @patch('promoter.dlrn_client.DlrnClient.fetch_jobs')
    @patch('promoter.dlrn_client.DlrnClient.get_civotes_info')
...
class TestPromoteAll(ConfigSetup):
    ...
    @patch('logging.Logger.info')
    @patch('promoter.dlrn_client.DlrnClient.fetch_current_named_hashes')
    @patch('promoter.logic.Promoter.promote_label_to_label')
...
class TestSelectCandidates(ConfigSetup):
    ...
    @mock.patch('promoter.dlrn_client.DlrnClient.fetch_promotions')
