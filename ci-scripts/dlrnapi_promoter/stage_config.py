...
class StageConfig(PromoterConfig):
    ...
    def _constructor_log_file(self):
        ...
        log_name = "{}-{}.log".format(self['distro'],
                                      self['release'])
        return os.path.join(self['stage_root'], log_name)
    ...
    def _filter_containers(self, containers):
        ...
        containers_list_exclude_config = containers['containers_list_exclude_config']
