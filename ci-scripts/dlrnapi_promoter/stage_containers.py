...
- imagename: "quay.io/tripleomaster/centos-binary-nova-compute:current-tripleo"
  image_source: kolla
''' # noqa
...
class StagingContainers(object):
    ...
    def __init__(self, config):
        ...
        self.build_method = \
            self.config.containers['build_method']
    ...
    def generate_containers_yaml(self):
        ...
        with open(tripleo_containers_path, "w") as containers_file:
            containers_file.write(containers_template)
