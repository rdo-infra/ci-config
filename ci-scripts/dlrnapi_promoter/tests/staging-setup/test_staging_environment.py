...
job by looking mainly at its output: the file, the directory structure, the list
...
def staged_env():
    """
    Fixture that runs the staging environment provisioner, yields the files produced
    and cleans up after
    """
