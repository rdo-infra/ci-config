...
def test_containers(staged_env):
    ...
    for full_name in stage_info['containers']:
        # Check if we upload the containers for the promotion candidate
        # hash
        candidate_full_hash = \
            stage_info['promotions']['promotion_candidate']['full_hash']
        current_full_hash = \
            stage_info['promotions']['currently_promoted']['full_hash']
        assert candidate_full_hash in full_name or current_full_hash in full_name
