...
class TestCleanupScript(unittest.TestCase):
    ...
    def test_heat_stacks(self):
        ...
        with open(full_path + '/data/data_stack.json') as file:
    ...
    def test_servers_with_identifier(self):
        ...
        full_path = os.path.dirname(os.path.abspath(__file__))
        with open(full_path + '/data/data_server.json') as file:
            loaded_data = json.load(file)
        json_data_string = json.dumps(loaded_data)
        with mock.patch('ovb_tenant_cleanup.fetch_resources',
                        return_value=json_data_string):
            obtained = ovb_tenant_cleanup.servers_with_identifier(
                           "765249_2_63940")
    ...
    def test_networks_with_identifier(self):
        ...
        full_path = os.path.dirname(os.path.abspath(__file__))
        with open(full_path + '/data/data_network.json') as file:
            loaded_data = json.load(file)
        json_data_string = json.dumps(loaded_data)
        with mock.patch('ovb_tenant_cleanup.fetch_resources',
                        return_value=json_data_string):
            obtained = ovb_tenant_cleanup.networks_with_identifier(
                           "765249_2_63940")
    ...
    def test_subnets_with_identifier(self):
        ...
        full_path = os.path.dirname(os.path.abspath(__file__))
        with open(full_path + '/data/data_subnet.json') as file:
            loaded_data = json.load(file)
        json_data_string = json.dumps(loaded_data)
        with mock.patch('ovb_tenant_cleanup.fetch_resources',
                        return_value=json_data_string):
            obtained = ovb_tenant_cleanup.subnets_with_identifier(
                           "765249_2_63940")
    ...
    def test_ports_of_subnets(self):
        ...
        full_path = os.path.dirname(os.path.abspath(__file__))
        with open(full_path + '/data/data_port.json') as file:
            loaded_data = json.load(file)
        json_data_string = json.dumps(loaded_data)
        with mock.patch('ovb_tenant_cleanup.fetch_resources',
                        return_value=json_data_string):
