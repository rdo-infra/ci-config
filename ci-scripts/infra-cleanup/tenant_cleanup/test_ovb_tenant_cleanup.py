...
class CloudResourcesTest(unittest.TestCase):
    ...
    def test_env_accessibility_check_when_cloud_reachable(self,
                                                          mock_conn,
                                                          mock_connect):
    ...
    def test_env_accessibility_check_when_cloud_unreachable(self,
                                                            mock_conn,
                                                            mock_connect):
    ...
    def test_network_when_identifier_is_123456_negative_test(self, mock_conn,
        ...
        mock_conn.network.networks.return_value = iter(
                self.mocked_network_list)
        self.assertEqual(
                ovb_tenant_cleanup.networks_with_identifier("123456"), [])
...
class HeatTests(unittest.TestCase):
    ...
    def test_failed_heat_stacks(self):
        ...
        self.assertEqual(ovb_tenant_cleanup.failed_heat_stacks(),
                         ['baremetal_73703'])
