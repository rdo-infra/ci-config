...
from ansible.module_utils.artifact_promoter import compose_promoter
from ansible.module_utils.artifact_promoter import promoter
...
def run_module():
    ...
    if module.params['promotion_type'] == 'centos-compose':
        ...
        prom_obj = compose_promoter.FileArtifactPromoter(
            sftp_client,
            module.params['working_dir'],
        )
