...
LATEST_CENTOS_8_STREAM = 'latest-CentOS-Stream-8'
LATEST_COMPOSE_URL = 'https://composes.centos.org/%(compose)s/COMPOSE_ID'
...
class ComposePromoter:
    ...
    def __init__(self, client, working_dir, distro='centos8',
                 compose_url=None):
        ...
        self.compose_url = (
                compose_url or LATEST_COMPOSE_URL % {
                    'compose': LATEST_CENTOS_8_STREAM
                }
        )
        # Set sftp client
        self.client = client
