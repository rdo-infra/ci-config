...
Copying only one single container, for example from another registry::
    ...
    copy-quay --debug --pull-registry quay.ceph.io --token $TOKEN \
              ...
              --tag v4.0.13-stable-4.0-nautilus-centos-8-x86_64 copy daemon

In the example above, it will copy the daemon tagged with v4.0.13-stable-4.0-nautilus-centos-8-x86_64 container
