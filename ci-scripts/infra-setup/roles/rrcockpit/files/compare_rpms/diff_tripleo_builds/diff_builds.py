...
class DiffBuilds(object):
    ...
    def diff_packages(self, control_list, test_list,
    ...
    def check_for_even_nodes(self, nodes, column_list):
        ...
        return [False, error, column_list]
    ...
    def execute_installed_package_diff(self, cache, control_url, test_url, all_available, ignore_packages):
        full_package_diff = {}
        logging.info(
