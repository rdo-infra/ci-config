...
def main():
    ...
    parser.add_argument(
        "--tempest_dump_dir",
        default=tempfile.mkdtemp(prefix="skiplist"),
...
def get_last_build(
        job_name, tempest_log, tempest_dump_dir):
    """
     ...
     Parameters:
         ...
         tempest_dump_dir: temporary directory to store stestr_results.html
...
def download_tempest_file(url, temp):
    """
