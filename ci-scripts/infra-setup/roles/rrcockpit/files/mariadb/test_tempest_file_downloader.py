...
def test_get_last_build_stestr(
        requests_mock,
        dump_dir_mock,
        tempest_cache_mock,
        job_name,
    ...
    tempest_cache_mock.assert_called_with(
        'http://logs.rdoproject.org/75/24375/1/check/periodic-'
        'tripleo-ci-centos-7'
        '-ovb-1ctlr_2comp-featureset021-master/08cf5f8/'
        '/logs/stestr_results.html',
        '/tmp/skiplist')
...
@pytest.mark.parametrize(
    "url",
    [
        'http://logs.rdoproject.org/openstack-periodic-master'
        '/opendev.org/openstack/tripleo'
        '-ci/master/periodic-tripleo-ci-centos-7-ovb-'
        '1ctlr_2comp-featureset021-master'
        '/5b535f9/logs/stestr_results.html',
        'http://logs.rdoproject.org/openstack-periodic-'
        'wednesday-weekend/opendev.org'
        '/openstack/tripleo-ci/master/periodic-tripleo-ci-'
        'centos-7-ovb-1ctlr_2comp'
...
def ttest_dowmload_tempest_file(url, tempest_dump_dir):
    result = tempest_file_downloader.download_tempest_file(
        url, tempest_dump_dir)
