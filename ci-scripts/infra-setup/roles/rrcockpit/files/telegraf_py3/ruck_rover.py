...
def print_failed_in_criteria(input_set,
    ...
    for job in input_set:
        int_history = get_job_history(job, ZB_RDO, component)
...
def track_integration_promotion(aggregate_hash,
                                release='master',
...
@ click.option("--aggregate_hash",
               required=False,
               default="tripleo-ci-testing/delorean.repo.md5",
               # TO-DO w/ tripleo-get-hash
               help=("default:tripleo-ci-testing/delorean.repo.md5"
                     "\nexample:tripleo-ci-testing/e6/ad/e6ad..."))
def main(release='master',
         influx=False,
         component=None,
         compare_upstream=False,
         aggregate_hash="tripleo-ci-testing/delorean.repo.md5"):
    if component:
