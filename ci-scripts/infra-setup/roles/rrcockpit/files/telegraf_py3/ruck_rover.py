...
def main(release,
    ...
    if release in ('osp16-2', 'osp17'):
        # to-do replace with internal config file hosted somewhere in internal
        downstream_urls = 'http://replace_with_internal/conf_ruck_rover.yaml'
    ...
    # override ZB_PERIODIC for downstream case
    global ZB_PERIODIC  # pylint: disable=global-statement
    ...
    # Git url for component promotion criteria
    global GIT_BASE_URL
