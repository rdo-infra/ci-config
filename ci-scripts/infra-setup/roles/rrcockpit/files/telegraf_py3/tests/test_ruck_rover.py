...
class TestInfluxDBMeasurements(unittest.TestCase):
    ...
    def test_component(
            ...
            m_find_result_aggr, _m_find_jobs_int, m_latest_job, m_zuul,
            m_print):
        component = "all"
...
class TestRuckRoverInflux(unittest.TestCase):
    ...
    def test_empty_prepare_jobs(self):
        ...
        result = ruck_rover.prepare_jobs(jobs_in_criteria, jobs)
        self.assertEqual([], result)

    @mock.patch('ruck_rover.find_failure_reason')
    def test_prepare_jobs(self, m_failure_reason):
