...
class TestInfluxDBMeasurements(unittest.TestCase):
    ...
    def test_component(self, m_gather, m_get_comp, m_get_promo,
            m_fetch_hash, m_find_results, m_conclude, m_find_jobs_comp,
            m_web_scrape, m_find_result_aggr, _m_find_jobs_int,
            m_latest_job, m_print):
        component = "all"
        ...
        job1 = 'jobs_result,job_type=component,job_name=2nd_passed,release=wallaby name="promoted-components",test_hash="c6_03",criteria="True",status="5",logs="N/A",failure_reason="N/A",duration="N/A",component="cinder",distro="centos-8"'
        job2 = 'jobs_result,job_type=component,job_name=failed,release=wallaby name="promoted-components",test_hash="c6_03",criteria="True",status="0",logs="N/A",failure_reason="N/A",duration="N/A",component="cinder",distro="centos-8"'
        job3 = 'jobs_result,job_type=component,job_name=passed,release=wallaby name="promoted-components",test_hash="c6_03",criteria="True",status="9",logs="N/A",failure_reason="N/A",duration="N/A",component="cinder",distro="centos-8"'
        dlrn = 'dlrn-promotion,release=wallaby,distro=centos-8,promo_name=promo commit_hash="c6",distro_hash="03",aggregate_hash="hash",repo_hash="repo_hash",repo_url="repo_url",latest_build_date=1000,component="cinder",promotion_details="dlrn_api_url/api/civotes_detail.html?commit_hash=c6&distro_hash=03",extended_hash="None" 1000000000'

        output = '\n'.join([job1, job2, job3, dlrn])
        m_print.assert_called_once_with(output)
        #m_print.assert_has_calls([job1, dlrn, job2, dlrn, job3, dlrn], any_order=True)

    def test_integration(self, m_gather, _m_get_comp, m_get_promo,
            m_fetch_hash, m_find_results, m_conclude, _m_find_jobs_comp,
        ...
        job1 = 'jobs_result,job_type=integration,job_name=2nd_passed,release=wallaby name="promote_name",test_hash="test_hash",criteria="True",status="5",logs="N/A",failure_reason="N/A",duration="N/A",component="None",distro="centos-8"'
        job2 = 'jobs_result,job_type=integration,job_name=failed,release=wallaby name="promote_name",test_hash="test_hash",criteria="True",status="0",logs="N/A",failure_reason="N/A",duration="N/A",component="None",distro="centos-8"'
        job3 = 'jobs_result,job_type=integration,job_name=passed,release=wallaby name="promote_name",test_hash="test_hash",criteria="True",status="9",logs="N/A",failure_reason="N/A",duration="N/A",component="None",distro="centos-8"'
        dlrn = 'dlrn-promotion,release=wallaby,distro=centos-8,promo_name=promo commit_hash="c6",distro_hash="03",aggregate_hash="hash",repo_hash="repo_hash",repo_url="repo_url",latest_build_date=1000,component="None",promotion_details="dlrn_api_url/api/civotes_agg_detail.html?ref_hash=hash",extended_hash="None" 1000000000'

        output = '\n'.join([job1, job2, job3, dlrn])
        m_print.assert_called_once_with(output)
        #m_print.assert_has_calls([job1, job2, job3, dlrn], any_order=True)
