...
if __name__ == '__main__':
    ...
    parser.add_argument('-d',
                        ...
                        default='',
                        help="Gerrit patch url to zuul layout file,"
                             " We remove hold for jobs found in layout")
    ...
    parser.add_argument('--delete_with_id',
                        default='',
                        help="Remove/delete a node from node using id, "
                             "You will find the id on running --list command")
