...
def convert_builds_as_influxdb(queue):
    ...
    influxdb_line = "zuul-queue-status,url={url},pipeline={pipeline},queue={queue},job={name},refspec={refspec} result=\"{result}\",enque_time={enqueue_time},result_code={result_code} {ts}"
