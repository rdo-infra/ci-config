...
def convert_builds_as_influxdb(queue):
    ...
    influxdb_line = "zuul-queue-status,url={url},pipeline={pipeline},queue={queue},job={name},refspec={refspec} result=\"{result}\",start_time={start_time},enqueue_time={enqueue_time},enqueued_time={enqueued_time},result_code={result_code}"
