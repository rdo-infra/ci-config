...
export DELOREAN_URL="https://$DELOREAN_PUBLIC_HOST/centos7-train/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos7-train/$LINKNAME/delorean.repo"
