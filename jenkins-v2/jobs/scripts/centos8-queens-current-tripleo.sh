set -e
export RDO_VERSION='centos-queens'
export DELOREAN_HOST='trunk-primary.rdoproject.org'
export DELOREAN_PUBLIC_HOST='trunk.rdoproject.org'
export DELOREAN_URL="https://$DELOREAN_PUBLIC_HOST/centos7-queens/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos7-queens/$LINKNAME/delorean.repo"
export RDO_VERSION_DIR='queens'
...
export HASH_FILE="$WORKSPACE/delorean_queens_centos8_current_tripleo_hash"
