set -e
export RDO_VERSION='centos-stein'
export DELOREAN_HOST='trunk-primary.rdoproject.org'
export DELOREAN_PUBLIC_HOST='trunk.rdoproject.org'
export DELOREAN_URL="https://$DELOREAN_PUBLIC_HOST/centos7-stein/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos7-stein/$LINKNAME/delorean.repo"
export RDO_VERSION_DIR='stein'
...
export HASH_FILE="$WORKSPACE/delorean_stein_centos8_current_tripleo_hash"
