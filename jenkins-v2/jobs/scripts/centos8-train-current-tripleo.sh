...
export DELOREAN_URL="https://$DELOREAN_PUBLIC_HOST/centos8-train/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos8-train/$LINKNAME/delorean.repo"
