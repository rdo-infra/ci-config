...
export DELOREAN_URL="https://$DELOREAN_PUBLIC_HOST/centos9-master/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos9-master/$LINKNAME/delorean.repo"
