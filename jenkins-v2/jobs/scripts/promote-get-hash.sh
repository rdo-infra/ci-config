#!/bin/bash
# shellcheck disable=SC2155,SC2129

DELOREAN_REPO_BASE="https://$DELOREAN_PUBLIC_HOST/$DELOREAN_REPO"

CANDIDATE_URL="$DELOREAN_REPO_BASE/$CANDIDATE_LINKNAME/delorean.repo"
LAST_PROMOTED_URL="$DELOREAN_REPO_BASE/$PROMOTED_LINKNAME/delorean.repo"
...
echo "DELOREAN_URL = $DELOREAN_REPO_BASE/$CANDIDATE_LINKNAME/$NEW_HASH/delorean.repo" >> "$HASH_FILE"
