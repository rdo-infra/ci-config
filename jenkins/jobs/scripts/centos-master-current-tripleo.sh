...
export DELOREAN_URL="https://$DELOREAN_HOST/centos7-master/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_HOST/centos7-master/$LINKNAME/delorean.repo"
