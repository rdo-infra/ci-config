...
export DELOREAN_URL="https://$DELOREAN_HOST/centos7-newton/consistent/delorean.repo"
export LINKNAME='current-passed-ci'
export LAST_PROMOTED_URL="https://$DELOREAN_HOST/centos7-newton/$LINKNAME/delorean.repo"
