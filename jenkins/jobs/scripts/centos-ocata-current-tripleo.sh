...
export DELOREAN_URL="https://$DELOREAN_HOST/centos7-ocata/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_HOST/centos7-ocata/$LINKNAME/delorean.repo"
