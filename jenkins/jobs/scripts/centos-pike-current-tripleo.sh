...
export DELOREAN_URL="http://$DELOREAN_HOST/centos7-pike/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="http://$DELOREAN_HOST/centos7-pike/$LINKNAME/delorean.repo"
