set -e
export RDO_VERSION='centos-pike'
export DELOREAN_HOST='trunk-primary.rdoproject.org'
export DELOREAN_PUBLIC_HOST='trunk.rdoproject.org'
export DELOREAN_URL="https://$DELOREAN_PUBLIC_HOST/centos7-pike/${delorean_current_hash:-current-tripleo}/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos7-pike/$LINKNAME/delorean.repo"
...
export HASH_FILE='/tmp/pike_current_tripleo_hash'
