...
export DELOREAN_URL="https://$DELOREAN_HOST/centos7-pike/current-tripleo/delorean.repo"
...
export LAST_PROMOTED_URL="https://$DELOREAN_HOST/centos7-pike/$LINKNAME/delorean.repo"
