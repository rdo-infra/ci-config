set -e
export RDO_VERSION='centos-ussuri'
...
export LAST_PROMOTED_URL="https://$DELOREAN_PUBLIC_HOST/centos8-ussuri/$LINKNAME/delorean.repo"
...
export HASH_FILE='/tmp/delorean_ussuri_current_tripleo_hash'
